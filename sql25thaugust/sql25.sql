...
(1, 'electronics', 'latest devices'),
(2, 'accessories', 'daily use items'),
(3, 'stationery', 'study essentials');
insert into products (pid, pname, pdes, cid) values
(101, 'iphone 15', 'apple smartphone', 1),
(102, 'dell xps', 'powerful laptop', 1),
(103, 'headphones', 'wireless headset', 2),
(104, 'notebook', 'spiral ruled book', 3);
...
select * from student where student_name like 'v%';
select * from student where student_name like '%a';
select * from student where student_name like '%un%';
